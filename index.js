...
hooks: {
  "page": function(page) {
    ...
    iframeContent += "<div class='cover'><div class='point one'></div><div class='point two'></div><div class='point three'></div></div>";
    iframeContent += "<iframe style='display:none' id='login-iframe' src='/login-iframe.html'></iframe>";
